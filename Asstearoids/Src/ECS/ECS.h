...
{
	static ComponentID lastID = 0u; //so it starts at 1
	return lastID++;
}
...
using ComponentBitSet = std::bitset<maxComponents>; //used to find out if an entity has a selection of components
...
{
private:
	EntityManager &manager; //manager ref
	bool active = true;
